...
urlpatterns = [
    ...
    path("manage/players/add/", views.manage_player_add, name="manage_player_add"),
    path("manage/players/<int:pk>/edit/", views.manage_player_edit, name="manage_player_edit"),
    path("manage/ratings/", views.manage_ratings, name="manage_ratings"),
    path("manage/ratings/add/", views.manage_rating_add, name="manage_rating_add"),
    path("manage/ratings/<int:pk>/edit/", views.manage_rating_edit, name="manage_rating_edit"),
